...
def display_clientes(dataclientes,titulo=''):
    if not dataclientes.empty:
        dataexport = dataclientes.copy()
        dataclientes.replace({None: '', np.nan: ''}, inplace=True)
        html_tabla = ""
        for _,i in dataclientes.iterrows():
            html_tabla += f""" 
            <tr>
              ...
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
                <h6 class="mb-0 text-sm">{i['nacionalidad']}</h6>
              </td>
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
                <h6 class="mb-0 text-sm">{i['tipoid']}</h6>
              </td>         
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
                <h6 class="mb-0 text-sm">{i['numeroid']}</h6>
              </td>     
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
                <h6 class="mb-0 text-sm">{i['pasaporte']}</h6>
              </td>  
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
                <h6 class="mb-0 text-sm">{i['nie']}</h6>
              </td>  
              <td class="align-middle text-center text-sm" style="border: none;padding: 8px;">
            ...
            <table class="table align-items-center mb-0" style="background-color: #ffffff;" >
                <thead>
                    <tr style="margin-bottom: 0px;background-color: #ffffff;">
                      ...
                      <th class="align-middle text-center" style="border-top:none; border-left:none;border-right:none;border-bottom: 1px solid #ccc;">Nacionalidad</th>
                      <th class="align-middle text-center" style="border-top:none; border-left:none;border-right:none;border-bottom: 1px solid #ccc;">Tipo ID</th>
                      ...
                      <th class="align-middle text-center" style="border-top:none; border-left:none;border-right:none;border-bottom: 1px solid #ccc;">Pasaporte</th>
                      <th class="align-middle text-center" style="border-top:none; border-left:none;border-right:none;border-bottom: 1px solid #ccc;">NIE</th>
